...
my_review_2 = Review.create({book_title: "White Oleander", author: "Janet Fitch", start_date: "2013-03-12", finish_date: "2013-04-01", review_content: Faker::Lorem.paragraph, book_rating: 5, user_id: 1})
